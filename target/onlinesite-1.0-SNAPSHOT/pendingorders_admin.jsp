  ...
  <div class="container-fluid">
    ...
    <div class="navbar-search">
      <div class="search-container">
        <form action="search_for_order_by_orderno_pendingorders.jsp">
    ...
    <div class="navbar-search">
      <div class="search-container">
        <form action="search_for_order_by_email_pendingorders.jsp">
        ...
        <div class="panel panel-success">
          ...
          <div class="panel-body">
            ...
            >
              ...
              <tbody>
              <%
                ResultSet resultOrders = Connect_to_sql.getResultFromSqlQuery("select * from orders natural join orders_custinfo natural join orders_item where order_status='Pending' order by id desc");
