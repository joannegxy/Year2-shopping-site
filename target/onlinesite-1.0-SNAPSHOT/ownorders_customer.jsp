    ...
    <div class="table-responsive">
      <table class="table table-bordered">
        ...
        <%
          ...
          ResultSet totalProduct = Connect_to_sql.getResultFromSqlQuery("select * from orders natural join orders_custinfo natural join orders_item where customer_name='" + session.getAttribute("name") + "' order by order_date desc");
        ...
        <tr class="rem1">
          ...
          <td class="invert"><img src="uploads/<%=totalProduct.getString(13)%>" style="width: 150px; height: 150px;"><br><%=totalProduct.getString(14)%></td>
          <td class="invert"><%=totalProduct.getString(15)%></td>
          <td class="invert"><del><%=totalProduct.getString(16)%></del></td>
          <td class="invert"><%=totalProduct.getString(17)%></td>
          <td class="invert"><%=totalProduct.getString(18)%></td>
          <td class="invert"><%=totalProduct.getString(5)%></td>
          <%
            //If order is delivered
            if (totalProduct.getString(4).equals("Deliver")) {
          %>
