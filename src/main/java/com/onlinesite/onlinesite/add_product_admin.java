...
@WebServlet("/add_product_admin")
public class add_product_admin extends HttpServlet {

    //Path where all the images are stored
    private final String UPLOAD_DIRECTORY = "C:\\JavaEE\\Apache Software Foundation8.5\\Tomcat 8.5\\webapps\\onlinesite\\src\\main\\webapp\\uploads";
        ...
        if (ServletFileUpload.isMultipartContent(request)) {
            try {
                ...
                try {
                    ...
                    int i = Connect_to_sql.insertUpdateFromSqlQuery("insert into product(id,active,code,description,image,image_name,name,price,ori_price,product_category) values('" + id + "','" + status + "','" + code + "','" + descrip + "','" + imagePath + "','" + imageName + "','" + productName + "','" + productPrice + "','" + oriPrice + "','" + category + "')");
