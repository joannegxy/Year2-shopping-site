...
<div class="electronics">
    <div class="container">
        ...
        <div class="ele-bottom-grid">
            <div class="dropdown">
                <button class="dropbtn">View by Category</button>
                <div class="dropdown-content">
                    <a href="viewallproducts_customer.jsp">All Products</a>
                    <a href="viewaccessoriesproducts_customer.jsp">Accessories</a>
                    <a href="viewbagsproducts_customer.jsp">Bags</a>
                    <a href="viewdressproducts_customer.jsp">Dress</a>
                    <a href="viewshirtproducts_customer.jsp">Shirts</a>
                </div>
            </div>
            <br><br><br>
            <%
                ResultSet retriveProduct = Connect_to_sql.getResultFromSqlQuery("select * from product where product_category='Accessories'");
