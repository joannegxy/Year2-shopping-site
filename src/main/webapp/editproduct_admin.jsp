      ...
      <div class="col-md-12">
        <div class="panel panel-info">
          ...
          <%
            ...
            ResultSet updateResult = Connect_to_sql.getResultFromSqlQuery("select * from product where id='" + id + "' ");
            while (updateResult.next()) {
          %>
          <div class="panel-body">
            <form role="form" action="editproduct2_admin.jsp"
                  method="post">
              ...
              <div class="form-group">
                <label>Ori. Price</label> <input class="form-control" type="text" name="mprice" value="<%=updateResult.getString("ori_price")%>" />
              </div>
              <div class="form-group">
