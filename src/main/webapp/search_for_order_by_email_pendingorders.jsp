                    ...
                    <div class="panel-body">
                        ...
                        >
                            ...
                            <%
                                ...
                                String sql="select * from orders natural join orders_custinfo natural join orders_item where order_status='Pending' and email_id like '%" +search+ "%' order by id desc";
