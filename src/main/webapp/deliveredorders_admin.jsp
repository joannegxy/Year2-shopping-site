        ...
        <div class="panel panel-success">
          ...
          <div class="panel-body">
            ...
            >
              ...
              <tbody>
              <%
                ResultSet resultOrders = Connect_to_sql.getResultFromSqlQuery("select * from orders natural join orders_custinfo natural join orders_item where order_status='Deliver' order by id desc");
