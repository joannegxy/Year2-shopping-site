...
<div class="content-wrapper">
    <div class="container">
        ...
        %>
        <div class="alert alert-info" id="success">Product added successfully.</div>
        <%
            }
        %>
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        <form role="form" action="add_product_admin" method="post"
                            ...
                            <div class="form-group">
                                <label>Ori Price</label> <input class="form-control" type="number" name="mprice" required/>
                            </div>
                            <div class="form-group">
                                <label>Status</label>
